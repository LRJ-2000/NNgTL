...
class NeuralTree(object):
    ...
    def __init__(self, workspace, buchi, init_state, init_label, acc_state, segment, prob, prob_nodes, para):
        """
        ...
        :param acc_state: feasible accepting state selected according to the predicted probability
